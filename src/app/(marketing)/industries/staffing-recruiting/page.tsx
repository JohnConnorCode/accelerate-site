...
const vertical = verticals.find((v) => v.slug === "staffing-recruiting")!;

const bundledMetadata = seoMetadata({
  title: "Staffing & Recruiting AI & Business Automation",
  description: vertical.shortDescription,
  ogTitle: "Staffing & Recruiting AI & Business Automation",
  ogSubtitle: "Practical inquiry and delivery workflows",
  path: "/industries/staffing-recruiting",
});

const breadcrumbJsonLd = generateBreadcrumbJsonLd([
  { name: "Home", url: "/" },
  { name: "Industries", url: "/industries" },
  { name: "Staffing & Recruiting", url: "/industries/staffing-recruiting" },
]);

export default async function IndustryPage() {
  const published = await publishedWebsiteOverride("/industries/staffing-recruiting");
...
export async function generateMetadata() {
  return (await publishedWebsiteMetadata("/industries/staffing-recruiting")) ?? bundledMetadata;
}
