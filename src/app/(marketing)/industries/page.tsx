            ...
            <div className="min-w-0">
              ...
              <AnimateOnScroll delay={0.3}>
                <p className="mt-7 max-w-xl text-lg leading-relaxed text-white-secondary">
                  We learn the workflows, constraints, tools, and opportunities that are specific to
                  your business, then recommend and deliver the AI, automation, training, or
                  execution that fits.
                </p>
              </AnimateOnScroll>
            </div>
            <AnimateOnScroll as="div" delay={0.2} className="mx-auto w-full max-w-sm">
              <div className="relative overflow-hidden rounded-3xl border border-border-glass bg-[color-mix(in_srgb,var(--bg-elevated)_92%,transparent)] p-7 backdrop-blur-md sm:p-8">
                ...
                <ol className="relative flex flex-col gap-5">
                  <span
                    aria-hidden
                    className="absolute bottom-2 left-[15px] top-2 w-px bg-border-gold"
                  />
                  {[
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
          ...
          <div className="flex flex-col gap-7">
            <p className="text-lg leading-relaxed text-white-secondary">
              In thirty minutes, we can identify where AI or automation may be useful and whether
              consulting, a focused build, training, managed execution, or a larger integrated
