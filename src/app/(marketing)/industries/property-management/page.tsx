...
const vertical = verticals.find((v) => v.slug === "property-management")!;

const bundledMetadata = seoMetadata({
  title: "Property Management AI & Business Automation",
  description: vertical.shortDescription,
  ogTitle: "Property Management AI & Business Automation",
...
const breadcrumbJsonLd = generateBreadcrumbJsonLd([
  ...
  { name: "Property Management", url: "/industries/property-management" },
]);

export default async function IndustryPage() {
  const published = await publishedWebsiteOverride("/industries/property-management");
...
export async function generateMetadata() {
  return (await publishedWebsiteMetadata("/industries/property-management")) ?? bundledMetadata;
}
