...
const vertical = verticals.find((v) => v.slug === "fitness-studios")!;

const bundledMetadata = seoMetadata({
  title: "Fitness Studios AI & Business Automation",
  description: vertical.shortDescription,
  ogTitle: "Fitness Studios AI & Business Automation",
...
const breadcrumbJsonLd = generateBreadcrumbJsonLd([
  ...
  { name: "Fitness Studios", url: "/industries/fitness-studios" },
]);

export default async function IndustryPage() {
  const published = await publishedWebsiteOverride("/industries/fitness-studios");
...
export async function generateMetadata() {
  return (await publishedWebsiteMetadata("/industries/fitness-studios")) ?? bundledMetadata;
}
