...
const vertical = verticals.find((v) => v.slug === "pet-services")!;

const bundledMetadata = seoMetadata({
  title: "Pet Services AI & Business Automation",
  description: vertical.shortDescription,
  ogTitle: "Pet Services AI & Business Automation",
...
const breadcrumbJsonLd = generateBreadcrumbJsonLd([
  ...
  { name: "Pet Services", url: "/industries/pet-services" },
]);

export default async function IndustryPage() {
  const published = await publishedWebsiteOverride("/industries/pet-services");
...
export async function generateMetadata() {
  return (await publishedWebsiteMetadata("/industries/pet-services")) ?? bundledMetadata;
}
