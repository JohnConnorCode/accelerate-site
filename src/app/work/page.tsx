      ...
      <section className="page-offset border-b border-[var(--rule)] py-[clamp(4rem,10vw,10rem)]">
        <Container>
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.12fr)_minmax(18rem,.55fr)] lg:items-end">
            ...
            <WorkReveal delay={0.16} className="border-l-2 border-[var(--fg)] pl-6 lg:pb-1"><p className="text-pretty text-[0.96rem] leading-7 text-[var(--mid)]">We build AI-enabled operations, software products, and growth systems around the way a business actually works. Every case below shows that capability in practice.</p><BookCallButton className="mt-7" location="work_index_hero" /></WorkReveal>
          </div>
        </Container>
      </section>
      <WorkIndex />
