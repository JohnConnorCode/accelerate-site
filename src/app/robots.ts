...
export default function robots(): MetadataRoute.Robots {
  if (distributionProfile() === "neutral") return { rules: { userAgent: "*", allow: "/", disallow: ["/api/", "/admin/", "/demo/"] }, host: tenant.brand.siteUrl, sitemap: `${tenant.brand.siteUrl}/sitemap.xml` };
  return {
    rules: [
      {
        userAgent: "*",
