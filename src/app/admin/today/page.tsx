...
import { AlarmClock, ArrowRight, Check, CheckCircle2, CircleDollarSign, Loader2, Mail, Megaphone, RefreshCw, ServerCog, ShieldCheck, Target, TriangleAlert, X } from "lucide-react";
...
export default function TodayPage() {
  ...
  if (loading && !overview) return <AdminPageLoading title="Today" subtitle="The founder queue: replies, commitments, meetings, proposals, approvals, and system exceptions in revenue order." variant="page" />;
