              ...
              {items.map((item) => (
                <li key={item.actionId}>
                  ...
                  >
                    ...
                    <span className="flex items-center gap-2 text-xs text-white-muted">
                      <span
                        className={cn(
          ...
          {selected && (
            <AdminSurface className="flex flex-col gap-4">
              ...
              {selected.evidence.length > 0 && (
                <div>
                  <h3 className="mb-1 text-xs font-semibold uppercase tracking-wider text-white-muted">
                    Match evidence
                  </h3>
              ...
              <div>
                <h3 className="mb-2 text-xs font-semibold uppercase tracking-wider text-white-muted">
                  Candidate records
                </h3>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="ml-auto inline-flex items-center gap-1.5 rounded-xl px-4 py-2 text-sm text-white-muted disabled:opacity-50"
                >
