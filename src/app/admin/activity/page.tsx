...
function entityHref(entityType: string, entityId: string | null) {
  ...
  if (entityType === "opportunity")
    return `/admin/pipeline?opportunity=${encodeURIComponent(entityId)}`;
  ...
  if (entityType === "integration" || entityType === "integration_connection")
...
export default function ActivityPage() {
  ...
  const options = historyQuery.data?.filterOptions ?? {
    actors: [],
    entityTypes: [],
    actions: [],
    sources: [],
          ...
          <div className="flex flex-col gap-3 p-4 sm:p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <h2 className="mt-1 text-balance text-base font-semibold">
                  Narrow the ledger without leaving this page
                </h2>
              </div>
              {activeFilterCount > 0 && (
                <button
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 xl:grid-cols-6">
              <FilterSelect
                ...
                onChange={(name, value) => replaceFilters({ [name]: value })}
              />
              <FilterSelect
                label="Entity"
                name="entity"
              ...
              <label className="min-w-0">
                ...
                <input
                  ...
                  className="admin-field min-h-11 w-full [color-scheme:light] dark:[color-scheme:dark]"
                />
              </label>
              <label className="min-w-0">
                ...
                return (
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <h2 className="mt-1 truncate text-sm font-semibold text-[var(--admin-ink)]">
                      ...
                      {change && (
                        <p className="admin-copy mt-1 line-clamp-2 text-pretty text-xs">{change}</p>
                      )}
                    </div>
