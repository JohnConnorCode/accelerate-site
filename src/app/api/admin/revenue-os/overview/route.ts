...
export async function GET() {
  ...
  try {
    const [queue, opportunitiesResult, campaignResult, conversationsResult, proposalsResult, integrationResult] = await Promise.all([
    ...
    const firstError = [opportunitiesResult.error, campaignResult.error, conversationsResult.error, proposalsResult.error, integrationResult.error].find(Boolean);
