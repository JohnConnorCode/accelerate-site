...
export const websitePathSchema = z
  ...
  .refine(
    (path) =>
      !/^\/(?:api|admin|t|f|auth|login|logout|setup|site-preview|site-pages|site-assets|demo|proposal|plan|plan-builder|ai-readiness|style-guide|docs|blog|results|packages|legacy-home)(?:\/|$)/.test(
        path,
      ),
