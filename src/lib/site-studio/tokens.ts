...
const BACKGROUNDS: Record<NonNullable<SiteStyles["background"]>, { background: string; color: string }> = {
  surface: { background: "var(--site-surface, #faf8f4)", color: "var(--site-ink, #1a1714)" },
  surfaceDark: { background: "var(--site-surface-dark, #1a1714)", color: "var(--site-paper, #faf8f4)" },
