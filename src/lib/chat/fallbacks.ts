...
Here's the better version of this conversation anyway: 30 minutes with John, free. He'll look at how work comes into your business today, where it's leaking, and which parts a few AI teammates could take off your plate. You'll leave knowing what to do first, whether or not you ever hire us.
...
Or email John directly: ${CONTACT_EMAIL}`;

export const ERROR_REPLY = `Something went wrong on my end. Give it another try in a moment.

Or skip me entirely and take 30 minutes with John: ${BOOKING_URL}. It's free, there's no catch, and you'll leave with a plan for where AI fits in your business. Email works too: ${CONTACT_EMAIL}`;
