 ...
 */
export const REVENUE_SCHEMA_CONTRACT_VERSION = "revenue-os.2026-09-12.7";
...
export const REVENUE_SCHEMA_FUNCTIONS = [
  ...
  "public.apply_identity_review_action(uuid,jsonb,text)",
  "public.apply_contact_import_row(uuid,uuid,text,text)",
  "public.finish_contact_import_batch(uuid,text)",
