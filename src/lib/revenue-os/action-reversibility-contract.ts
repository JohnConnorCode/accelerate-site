...
export const ACTION_REVERSIBILITY: readonly ActionReversibility[] = [
  ...
  },
  {
    ...
    impact: "external_action",
    reversibility: "irreversible",
    rationale: "Canonical intake may acknowledge the inquiry under the configured responder policy. Review is required and delivered messages cannot be recalled.",
  },
  {
    actionType: "site_website_change",
    impact: "external_action",
    reversibility: "compensable",
    rationale: "Immutable website revisions support a separately authorized rollback or unpublish. Prior public exposure cannot be undone.",
  },
  {
