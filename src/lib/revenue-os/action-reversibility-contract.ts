...
export const ACTION_REVERSIBILITY: readonly ActionReversibility[] = [
  {
    ...
    rationale:
      "Restore the prior status and unread count only while the captured conversation state is unchanged.",
  },
  {
    ...
    reversibility: "reversible",
    rationale:
      "Restore the prior assignment against unchanged state; a restored assignee must still be an active workspace member.",
  },
  {
    ...
    rationale:
      "Correct links with a new reviewed change; original human evidence remains part of the history.",
  },
  {
