...
export const EXTENSION_MODULES: readonly RevenueOSModule[] = [
  {
    ...
    routes: [],
    setupChecks: [],
    docsUrl: "/docs/plugins/business-pulse",
    report: {
      version: 1,
      sources: [
        {
  ...
  },
  {
    ...
    workflow: {
      ...
      contractHash: "93afea22aa539d27056a1328ed1469f2e3d764ccedf4bfe40eb67d4eed2ea3e4",
      tools: [
        {
  ...
  },
  {
    ...
    routes: [],
    setupChecks: [],
    docsUrl: "/docs/plugins/commitment-watch",
    report: {
      version: 1,
      sources: [
        {
  ...
  },
  {
    ...
    setupChecks: [],
    docsUrl: "/docs/plugins/example-inventory",
    settings: [
      {
  ...
  },
  {
    ...
    setupChecks: [],
    docsUrl: "/docs/plugins/meeting-commitments",
    workflow: {
      version: 1,
      inputSchema: {
        type: "object",
      ...
      contractHash: "0f4d6c9d5d93e235f5c4b41848695dbcb55cd918fd8fda1171e1480b8fa53d6b",
      tools: [
        {
          operation: "prepare-workflow",
  ...
  },
  {
    ...
    routes: [],
    setupChecks: [],
    docsUrl: "/docs/plugins/meeting-prep",
    report: {
      version: 1,
      sources: [
        {
  ...
  },
  {
    ...
    setupChecks: [],
    docsUrl: "/docs/plugins/opportunity-radar",
    settings: [
      {
        key: "organization",
        label: "Organization",
  ...
  },
  {
    ...
    routes: [],
    setupChecks: [],
    docsUrl: "/docs/plugins/pipeline-watch",
    report: {
      version: 1,
      sources: [
        {
  ...
  },
  {
    ...
    setupChecks: [],
    docsUrl: "/docs/plugins/receivables-collections",
    settings: [
      {
        key: "cooldownHours",
  ...
  },
  {
    ...
    workflow: {
      ...
      contractHash: "0b6f2e366392e98f0e6f1dc672cbefbd93e2e03d4e35f681d277f9fb58506aa4",
      tools: [
        {
          operation: "prepare-workflow",
