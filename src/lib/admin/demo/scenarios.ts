...
function makePack(input: {
  id: DemoScenarioId; name: string; category: string; description: string; accent: string; founder: string; domain: string;
