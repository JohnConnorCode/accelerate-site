...
export const DEMO_BLUEPRINT_DETAIL: DemoBlueprintDetail = {
  ...
  "document": {
    ...
    "businessSummary": "Example Manufacturing Co. sells custom projects: deposit, sampling, client review, bulk production, QA, shipment, final payment.",
    "evidenceRefs": [
      {
        "kind": "fact",
    ...
    "unresolvedQuestions": [
      "Who approves discounts over 10%?"
    ],
    "navigation": [
      {
        "label": "Sales",
    ...
    "workflows": [
      {
        ...
        "detail": "Trigger record_transition opportunity.stage -> won · 3 steps (0 blocked, 1 need approval)",
        "status": "approval",
    ...
    "coworkers": [
      {
        ...
        "title": "Operations",
        "detail": "Keep production orders moving and escalate stuck client reviews · review_stuck_order",
        "status": "ready",
        "statusReason": null,
        "impact": "structural"
      }
