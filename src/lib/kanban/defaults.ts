  ...
  pipeline: [
    {
      ...
      sort_order: 1000,
      is_default: true,
      metadata: { role: "open", probability: 10 },
    },
    {
      column_key: "contacted",
      label: "Contacted",
      color: null,
      sort_order: 2000,
      is_default: true,
      metadata: { role: "open", probability: 20 },
    },
    {
      ...
      sort_order: 3000,
      is_default: true,
      metadata: { role: "open", probability: 40 },
    },
    {
      column_key: "meeting",
      label: "Meeting",
    ...
    {
      column_key: "negotiation",
      label: "Negotiation",
      color: null,
      sort_order: 6000,
      is_default: true,
      metadata: { role: "open", probability: 85 },
    },
    {
      column_key: "won",
      label: "Won",
      ...
      sort_order: 7000,
      is_default: true,
      metadata: { role: "won", probability: 100 },
    },
    {
      column_key: "lost",
      label: "Lost",
      ...
      sort_order: 8000,
      is_default: true,
      metadata: { role: "lost", probability: 0 },
    },
    {
      column_key: "nurture",
      label: "Nurture",
