export const FEATURE_STATUSES = ["backlog", "planned", "in_progress", "blocked", "shipped"] as const;
...
export const FEATURE_STATUS_META: Record<FeatureStatus, { label: string; description: string; accent: string }> = {
  ...
  in_progress: { label: "In progress", description: "Actively being built", accent: "bg-amber-500" },
