          ...
          <div>
            ...
            <Reveal rv delay={0.06}>
              <h2 className="max-w-[16ch] text-balance font-display text-[clamp(2.2rem,5vw,5rem)] font-medium leading-[0.92] tracking-[-0.055em] text-[var(--fg)]">
                Systems that had to work in production.
              </h2>
            </Reveal>
            <Reveal rv delay={0.12}>
              <p className="mt-6 max-w-[62ch] text-pretty leading-7 text-[var(--mid)]">
                These projects show the operating experience behind Accelerate: finding the
                constraint, designing the right system, building it, and improving the work around
                it.
              </p>
            </Reveal>
          </div>
          <Reveal rv delay={0.16}>
            <Link href="/work" className="btn btn-sm">
              See all work{" "}
