...
const TRADES = [
  { href: "/industries/home-services", name: "Home services", visual: INDUSTRY_VISUALS["home-services"] },
  { href: "/industries/law-firms", name: "Law firms", visual: INDUSTRY_VISUALS["law-firms"] },
  { href: "/industries/professional-services", name: "Professional services", visual: INDUSTRY_VISUALS["professional-services"] },
