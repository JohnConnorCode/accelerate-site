...
const WHY = [
  {
    ...
    desc: "Up to 20% on every client you refer. Paid monthly with full transparency.",
  },
  {
    icon: Handshake,
    title: "White-label option",
    desc: "Deliver our services under your brand with wholesale pricing.",
  },
  {
    icon: Rocket,
    title: "Grow your business",
    desc: "Add AI solutions to your offering without building the technology yourself.",
  },
];
  ...
  return (
    <>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
            <div className="min-w-0">
              <HeroEntranceItem step={1}>
                <Eyebrow className="mb-7">partner program</Eyebrow>
              </HeroEntranceItem>
              ...
              <HeroEntranceItem step={3}>
                <p className="mt-7 max-w-xl text-lg leading-relaxed text-white-secondary">
                  Refer clients or white-label our work. We design, build, and run the AI systems,
                  accountable to results, so your name stays on the win. Earn recurring revenue for
            ...
            <HeroEntranceItem step={3} className="mx-auto w-full max-w-sm">
              <div className="relative overflow-hidden border border-[color-mix(in_srgb,var(--fg)_14%,transparent)] p-8">
                ...
                <div className="flex items-baseline gap-3">
                  <span className="font-display text-6xl font-extrabold leading-none tracking-[-0.03em] text-heading">
                    20%
                  </span>
                  <span className="font-display text-lg font-semibold leading-tight text-heading">
                    recurring
                    <br />
                    commission
                  </span>
                ...
                <p className="mt-5 text-sm leading-relaxed text-white-secondary">
                  On every client you refer, paid monthly, for as long as they stay with us.
                </p>
            ...
            return (
              ...
              >
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h3 className="font-display text-lg font-bold tracking-[-0.01em] text-heading">
                    {tier.name}
                  </h3>
                </div>
                <p
                  className={cn(
                    ...
                    featured ? "text-gold" : "text-gold-light",
                  )}
                >
                  {tier.commission}
                </p>
                <div className="mb-5">
                  <p className="mb-2 font-mono text-[0.6rem] uppercase tracking-[0.2em] text-white-muted">
                    Benefits
                  </p>
      ...
      <Section width="text" divide>
        <div
          id="apply"
          className="rounded-2xl border border-border-glass bg-[color-mix(in_srgb,var(--bg-elevated)_92%,transparent)] p-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_20px_60px_rgba(0,0,0,0.25)] backdrop-blur-md sm:p-10"
        >
          {submitted ? (
            <div className="py-6 text-center">
              ...
              <h2 className="mb-2 font-display text-2xl font-bold text-heading">
                Application received
              </h2>
              <p className="text-white-secondary">
                Thanks for your interest. We review applications within 2 business days and will be
                in touch soon.
              </p>
            </div>
          ) : (
            <>
              ...
              <p className="mb-7 text-white-muted">
                A few quick details and we&apos;ll be in touch.
              </p>
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium text-white-secondary">
                    Partner type *
                  </label>
                  <div className="grid grid-cols-3 gap-3">
                    {TYPE_OPTIONS.map((opt) => {
                      ...
                      return (
                        ...
                        >
                          <opt.icon
                            className={cn("h-5 w-5", on ? "text-gold" : "text-white-muted")}
                          />
                          {opt.label}
                        </button>
                      );
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
          ...
          <div className="flex flex-col gap-7">
            <p className="text-lg leading-relaxed text-white-secondary">
              Let&apos;s talk about how we can work together to deliver AI solutions to your
              clients.
            </p>
