...
export function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      className="relative py-24 bg-[var(--bg-section-deep)] overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <ScrollReveal animation="blur-up">
          <SectionHeader
            ...
            heading={
              <>
                From Strategy Call to <span className="text-gold">Live Systems</span>, Fast
              </>
            }
            className="mb-20"
          />
        ...
        <div ref={timelineRef} className="relative">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, var(--gold-base), rgba(var(--accent-rgb), 0.15))",
            }}
          />
              ...
              return (
                <div key={step.number} data-timeline-step className="relative pl-14 sm:pl-20">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-white-muted leading-relaxed max-w-lg">{step.description}</p>
                  </div>
                </div>
              );
            })}
