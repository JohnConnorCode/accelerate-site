...
const H1 =
  "font-display font-extrabold leading-[1.04] tracking-[-0.035em] text-[clamp(2.1rem,3.8vw,3.9rem)] text-heading";
const H2 =
  "font-display font-bold leading-[1.06] tracking-[-0.03em] text-[clamp(1.85rem,3.2vw,2.9rem)] text-heading";
...
const RELATED_READING: Record<string, RelatedArticle[]> = {
  "home-services": [
    ...
    },
    {
      ...
      title: "AI for Contractors: How Home Service Businesses Win More Jobs",
    },
    {
      slug: "servicetitan-vs-housecall-pro-vs-jobber",
      title: "ServiceTitan vs Housecall Pro vs Jobber, Compared for 2026",
    },
  ],
  "law-firms": [
    ...
    { slug: "ai-tools-law-firms-2026", title: "5 AI Tools Every Law Firm Should Be Using in 2026" },
    {
      ...
      title: "AI Client Intake for Personal Injury Firms: A Complete Guide",
    },
  ],
  "real-estate": [
    {
    ...
    },
    {
      ...
      title: "AI for Real Estate Teams: Automate Follow-Up, Close More Deals",
    },
  ],
  "professional-services": [
    {
      slug: "ai-for-accountants",
      title: "AI for Accountants and Bookkeepers: Automate Client Onboarding",
    },
  ...
  return (
    <>
                ...
                <OpsConsole
                  ...
                  footer={
                    <p className="text-center font-mono text-[0.6rem] uppercase tracking-[0.18em] text-white-muted">
                      A day at{" "}
                      {vertical.opsLabel ?? `a ${vertical.name.replace(/s$/, "").toLowerCase()}`},
                      run by Accelerate
                    </p>
                  }
                />
      ...
      <section className="section-y section-divide relative bg-[var(--bg-section-warm)]">
        <Container width="wide">
          <AnimateOnScroll>
            <Eyebrow className="mb-6">sound familiar?</Eyebrow>
          </AnimateOnScroll>
          <RevealHeading
        ...
        <Container width="wide">
          ...
          <AnimateOnScroll delay={0.15}>
            <p className="mb-12 max-w-2xl text-base leading-relaxed text-white-muted">
              Every solution here is scoped to your operations: your tools, your workflow, your
              goals.
            </p>
          </AnimateOnScroll>
          ...
          <div className="flex flex-col gap-4">
            <div className="grid gap-4 md:grid-cols-2">
              {heroSolutions.map((solution, i) => (
                ...
                >
                  <h3 className="mb-3 font-display text-xl font-semibold text-heading">
                    {solution.title}
                  </h3>
                  <p className="mb-5 leading-relaxed text-white-secondary">
            ...
            {restSolutions.length > 0 && (
              <div
                className={`grid gap-4 sm:grid-cols-2 ${restSolutions.length >= 3 ? "lg:grid-cols-3" : ""}`}
              >
                {restSolutions.map((solution, i) => (
                  ...
                  >
                    ...
                    <p className="mb-4 text-sm leading-relaxed text-white-muted">
                      {solution.description}
                    </p>
      ...
      {vertical.caseStudy && (
        <section className="section-y section-divide relative">
          <Container width="wide">
            <AnimateOnScroll>
              <Eyebrow className="mb-6">case study</Eyebrow>
            </AnimateOnScroll>
            <RevealHeading className={`${H2} mb-10 max-w-3xl`} lead={vertical.caseStudy.title} />
            <AnimateOnScroll
              delay={0.1}
              as="div"
              className="rounded-2xl border border-border-gold/40 bg-[color-mix(in_srgb,var(--gold-base)_4%,var(--bg-elevated))] p-8 backdrop-blur-md sm:p-12"
            >
              ...
              <div className="grid gap-3 sm:gap-4 md:grid-cols-4">
                {vertical.caseStudy.metrics.map((metric, i) => (
                  ...
                  >
                    <p className="mb-1 font-display text-2xl font-bold text-gold sm:text-3xl">
                      {metric.value}
                    </p>
      ...
      {relatedReading.length > 0 && (
        <section className="section-y section-divide relative bg-[var(--bg-section-warm)]">
          <Container width="wide">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="mb-12 max-w-2xl text-base leading-relaxed text-white-muted">
                Guides on the automation, intake, and follow-up systems we build and run for{" "}
                {vertical.name.toLowerCase()} businesses.
              </p>
            </AnimateOnScroll>

            <div
              className={`grid gap-4 sm:grid-cols-2 ${relatedReading.length >= 3 ? "lg:grid-cols-3" : ""}`}
            >
            ...
            <div className="flex flex-col gap-7">
              <AnimateOnScroll delay={0.15}>
                <p className="text-lg leading-relaxed text-white-secondary">
                  30 minutes. We&apos;ll map exactly where AI and automation move the needle for
                  your business. No pitch, no obligation.
                </p>
              </AnimateOnScroll>
              <AnimateOnScroll delay={0.25}>
                <BookCallButton location="industry_closing" />
              </AnimateOnScroll>
