...
export const workAccentClasses: Record<WorkProject["accent"], string> = {
  ...
  green: "[--case-accent:#347249] [--case-accent-ink:#fff] [--case-surface:color-mix(in_srgb,#347249_8%,var(--bg))]",
  violet: "[--case-accent:#7045b8] [--case-accent-ink:#fff] [--case-surface:color-mix(in_srgb,#7045b8_8%,var(--bg))]",
  gold: "[--case-accent:#b27a1d] [--case-accent-ink:#111] [--case-surface:color-mix(in_srgb,#b27a1d_8%,var(--bg))]",
  slate: "[--case-accent:#52606d] [--case-accent-ink:#fff] [--case-surface:color-mix(in_srgb,#52606d_7%,var(--bg))]",
};
...
export const heroAspectByArtDirection: Record<WorkProject["artDirection"]["hero"], "wide" | "portrait" | "cinematic" | "square"> = {
  wide: "cinematic",
  portrait: "portrait",
  system: "wide",
  window: "wide",
