...
function CmdKSearch({
  ...
  return (
    ...
    >
      <div className="admin-dialog-surface relative flex h-dvh w-full flex-col overflow-hidden bg-[var(--admin-surface)] text-[var(--admin-ink)] sm:h-auto sm:max-w-xl sm:rounded-[var(--admin-surface-radius)]">
