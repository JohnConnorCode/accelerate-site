      ...
      <div className="flex flex-wrap gap-2">
        {WORK_QUEUES.map((q) => (
          <button
            ...
            className={`min-h-10 rounded-xl border px-3 text-xs font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--admin-accent)] ${filters.queue === q.key ? "border-[var(--admin-accent)] bg-[var(--admin-accent-soft)]" : "border-[var(--admin-border)]"}`}
          >
            {q.label}
          </button>
        ))}
