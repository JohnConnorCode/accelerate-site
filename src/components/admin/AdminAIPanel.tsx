      ...
      {ai.open && (
        <>
          <motion.button
            ...
            className="fixed inset-0 z-[70] bg-black/45 backdrop-blur-[4px]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            <header className="flex min-h-16 items-center justify-between gap-3 border-b border-[var(--admin-border)] px-4">
              <div className="flex min-w-0 items-center gap-3">
                <span className="grid size-9 place-items-center rounded-xl bg-[var(--admin-ink)] text-[var(--admin-surface)]">
