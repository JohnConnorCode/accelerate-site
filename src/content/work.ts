...
export const workProjects: readonly WorkProject[] = [
  {
    ...
    visualBlocks: [
      ...
      { afterSection: 2, eyebrow: "The operating layer", title: "One command center for the work around the order.", intro: "The custom command center connects the daily check-in, approvals, customer conversations, orders, products, inventory, campaigns, and operational assistance. These screens show a controlled demo state; visible customer names and email addresses are fictional records.", layout: "interface-grid", tone: "paper", frame: "window", media: [
        ...
        image("/work/work-shelter/orders-workspace.webp", "WORK+SHELTER orders workspace showing order status, fulfillment context, search, export, and order actions", "Orders · controlled demo data", { fit: "contain" }),
        image("/work/work-shelter/products-inventory.webp", "WORK+SHELTER products and inventory workspace showing stock status, pricing, CSV actions, margins, and saved views", "Products and inventory · controlled demo data", { fit: "contain" }),
        image("/work/work-shelter/campaign-admin-help.webp", "WORK+SHELTER campaign composer with audience eligibility, email layouts, and page-aware read-only admin help", "Campaign execution and admin assistance · controlled demo state", { fit: "contain" }),
      ] },
    ],
  ...
  },
  {
    ...
    cardDescription: "A two-sided operating platform for advisors, healthcare-facility listings, documents, and vetted private-equity buyers.",
    ...
    description: "A two-sided platform connecting healthcare advisors, facility opportunities, and vetted buyers.",
    capabilities: ["Business process modeling", "Product strategy", "Custom software", "Workflow design"],
    serviceIds: ["strategy", "automation"],
    accent: "blue",
    composition: "platform",
    artDirection: { world: "clinical", hero: "system", rhythm: "architectural", mediaFrame: "paper" },
    cardMedia: diagram("healthcare-object-map", "The deal was the center of the product", "Accelerate case-study diagram · system model"),
    heroMedia: diagram("healthcare-object-map", "The deal was the center of the product", "Accelerate case-study diagram · system model"),
    sections: [
      { label: "Constraint", title: "The old system understood contacts. The business ran on deals.", body: "Healthcare real estate transactions involved advisors, vetted buyers, hundreds of facility listings, documents, photography, access rules, and both single-property and portfolio opportunities. An off-the-shelf CRM could store names, but it could not represent the work around them." },
      { label: "Analysis", title: "Model the business before designing the screens.", body: "The team mapped the operating objects, their relationships, the permissions each participant needed, and the actions that moved a deal forward. That model became the product architecture." },
      { label: "Architecture", title: "One late requirement could have broken the product.", body: "Portfolio deals changed the relationship between facilities, documents, buyers, and inquiries. Treating that requirement as an extra screen would have created brittle exceptions. The underlying model was adjusted so single assets and portfolios could move through the same system." },
      { label: "Intervention", title: "One operating environment for both sides of the transaction.", body: "Working with two UI designers and a distributed development team, the project delivered advisor and buyer experiences, listing management, document and photography workflows, permissions, and a visible deal pipeline over eight months." },
      { label: "Impact", title: "Deals moved faster.", body: "The documented result was a 40% reduction in inquiry-to-close time. The gain came from putting the actual transaction model in one operational system, not from adding another layer to the generic CRM." },
    ],
    visualBlocks: [
      { afterSection: 1, eyebrow: "System architecture", title: "Objects, permissions, and actions before interface polish.", intro: "The original product is private. This diagram communicates the operating model without fabricating a screen.", layout: "single", tone: "accent", media: [diagram("healthcare-deal-flow", "A shared path from opportunity to close", "Accelerate case-study diagram · based on the documented product architecture")] },
    ],
    ...
    seoDescription: "How a purpose-built healthcare real estate platform replaced a generic CRM and reduced inquiry-to-close time by 40%.",
  },
  {
    slug: "superdebate",
    visibility: "public",
    ...
    cardDescription: "Product and operating infrastructure spanning expert outreach, live debates, scoring, clubs, events, content, and AI-powered practice.",
    industry: "Debate and education",
    role: "Founder & product lead",
    relationship: "Founder-built company",
    timeline: "2022–present",
    description: "A debate company combining featured events, clubs, live online competition, judging, and private AI practice.",
    capabilities: ["Product architecture", "AI-enabled practice", "Managed operations", "Content systems"],
    ...
    sections: [
      { label: "Context", title: "Category-building creates work everywhere at once.", body: "SuperDebate spans featured debates, clubs, live online competition, scoring, judging, and private AI practice through Aurelius. The public product depends on expert research, outreach, scheduling, events, content, and relationship management behind it." },
      { label: "Operating model", title: "Treat the path from expert discovery to published debate as one system.", body: "Research, outreach, follow-up, scheduling, preparation, live production, publishing, and relationship history were designed as connected work. AI and automation support repetitive preparation while people own the invitation, editorial decision, and live exchange." },
      { label: "Product", title: "The same philosophy extends into the participant experience.", body: "Featured Debates create an editorial front door. Clubs organize communities. Online supports live competition. Scoring makes judging legible. Aurelius gives participants a private AI practice environment. Each surface belongs to the same activity rather than a bundle of unrelated features." },
    ...
    visualBlocks: [
      ...
      { afterSection: 2, eyebrow: "SuperDebate command center", title: "The company runs through the same system it keeps improving.", intro: "The black-and-yellow command center coordinates analytics, events, the product roadmap, email, applications, leads, support, clubs, and content. Counts and dates visible in these screens are interface state, not portfolio outcome claims.", layout: "interface-grid", tone: "ink", frame: "film", media: [
        ...
        image("/work/superdebate/admin-events.webp", "SuperDebate command center events workspace showing debate scheduling, registrations, filters, and page status", "Command center · events operations", { fit: "contain", canvas: "ink" }),
    ...
    seoDescription: "How SuperDebate develops its product, AI practice, live events, expert outreach, and internal operating system together.",
  },
  {
    slug: "sparkblox",
    visibility: "public",
    ...
    cardDescription: "A platform for brands and creators to create, launch, manage, and evolve digital assets without writing code.",
    proof: "$1M+ raised",
    industry: "Web3 software",
    role: "Founder & CEO",
    relationship: "Founder-built company",
    timeline: "2021–2024",
    description: "A no-code platform for creating, launching, embedding, and managing dynamic digital assets.",
    capabilities: ["Zero-to-one strategy", "Custom software", "Product design", "Technical translation"],
    serviceIds: ["strategy", "automation"],
    accent: "gold",
    composition: "company",
    ...
    sections: [
      ...
      { label: "Company building", title: "Building the company was part of building the product.", body: "The work extended beyond UX and feature definition into fundraising, technical direction, partnerships, artists, market positioning, and the constraints of shipping an emerging-technology product from zero." },
    ...
    seoDescription: "The founder-built story of Sparkblox, a funded no-code platform for creating, launching, and managing dynamic digital assets.",
  },
  {
    ...
    cardDescription: "Builder sourcing, ecosystem growth, positioning, and funding-program outreach across a fragmented Web3 landscape.",
    ...
    capabilities: ["Growth strategy", "Audience research", "Outreach systems", "Program operations"],
    serviceIds: ["strategy", "sales"],
    accent: "green",
    composition: "ecosystem",
    artDirection: { world: "brief", hero: "document", rhythm: "editorial", mediaFrame: "film" },
    cardMedia: image("/work/thrive-protocol/verification-hero.webp", "Current Thrive website introducing its verification layer for private-market investors and founders", "Thrive today · current company context", { fit: "contain", canvas: "ink" }),
    heroMedia: image("/work/thrive-protocol/verification-hero.webp", "Current Thrive website introducing its verification layer for private-market investors and founders", "Thrive today · current company context, not an engagement deliverable", { fit: "contain", canvas: "ink" }),
    sections: [
      { label: "Context", title: "Funding only works if the right builders find it.", body: "Thrive Protocol applies a Proof-of-Value model to ecosystem funding. The engagement focused on AI strategy, ecosystem growth, builder sourcing, funding opportunities, developer engagement, and the route from program awareness to a credible project." },
      { label: "Constraint", title: "Capital is not distribution.", body: "A program could have meaningful funding available and still miss the builders capable of using it. The problem was to identify serious teams across fragmented communities, understand fit, and make the next step clear without turning outreach into volume for its own sake." },
      { label: "Intervention", title: "Match the builder, opportunity, and incentive.", body: "The work combined target-builder profiles, research, qualification, personalized outreach, conversation, and funding-path guidance. AI could help organize signals and prepare work, but the judgment of whether a builder and program belonged together remained human." },
      { label: "Program example", title: "A funding program designed around accountability.", body: "XION's multi-season Anti-Grant program with Thrive made up to $12.6 million available and used milestone-based funding with Proof-of-Value review. That amount is program context only. It is not capital personally raised, sourced, or allocated by the specialist engagement." },
      { label: "Relevance", title: "Build the distribution layer around the funding layer.", body: "The work demonstrates a practical growth problem: a valuable offer does not move until the right audience, qualifying signal, conversation, and next action are designed as one operating path." },
    ],
    visualBlocks: [
    ...
    seoDescription: "Builder sourcing, AI strategy, and ecosystem growth work around Thrive Protocol's Proof-of-Value funding model.",
  },
  {
    slug: "green-goods",
    visibility: "public",
    ...
    cardDescription: "Field-friendly infrastructure for documenting, verifying, and translating real environmental work into evidence funders can use.",
    ...
    description: "A field-aware product model for recording conservation work and translating it into verifiable evidence.",
    capabilities: ["Product strategy", "Field workflow design", "Evidence systems", "Data & reporting"],
    serviceIds: ["strategy", "reporting"],
    accent: "green",
    composition: "field",
    artDirection: { world: "field", hero: "document", rhythm: "notebook", mediaFrame: "paper" },
    cardMedia: image("/work/green-goods/field-methodology.webp", "Green Goods methodology showing field evidence, verification, and mobile product screens", "Green Goods methodology and product today", { fit: "contain" }),
    heroMedia: image("/work/green-goods/field-methodology.webp", "Green Goods methodology showing field evidence, verification, and mobile product screens", "Green Goods methodology and product today", { fit: "contain" }),
    sections: [
      { label: "Origin", title: "The first version tried to solve too much.", body: "Green Goods grew from an earlier GreenPill hackathon concept. The initial idea bundled environmental work, incentives, verification, and technical novelty together. The product became clearer when the team returned to the people doing the work and the evidence they could realistically capture." },
      { label: "User", title: "The user was not a blockchain user.", body: "Initial users included scientists and gardeners in Brazil, often working with low bandwidth, shared devices, and Brazilian Portuguese. Wallets and infrastructure could not become another job. The field experience had to stay centered on the task." },
      { label: "Analysis", title: "Measuring the work was part of designing the product.", body: "A conservation task needed a clear definition, before-and-after evidence, operator review, and a record funders could understand. The difficult work was deciding what counted as credible evidence without making the process unusable in the field." },
      { label: "Experience", title: "Simple above. Verifiable underneath.", body: "The field worker captures the work. An operator reviews evidence and context. The infrastructure records an attestation behind the experience. Each layer has a distinct responsibility, so technical sophistication does not spill into the user's workflow." },
      { label: "Impact", title: "Enough evidence to earn support.", body: "The project received a $20,000 Octant Epoch 5 grant and a $29,000 ENS grant, totaling $49,000. Current product imagery is labeled Green Goods today because the project has continued to develop after the original product work." },
    ],
    visualBlocks: [
      { afterSection: 1, eyebrow: "The field model", title: "Evidence starts where the work happens.", layout: "single", tone: "accent", media: [diagram("green-goods-proof-flow", "From field task to fundable evidence", "Accelerate case-study diagram · simplified evidence flow")] },
      { afterSection: 3, eyebrow: "Green Goods today", title: "The product continues to develop.", intro: "These current screens show the direction of the product today. They are context, not a claim that every present feature belonged to the original engagement.", layout: "duo", tone: "paper", media: [
        image("/work/green-goods/product-screens.webp", "Current Green Goods mobile screens for capturing and reviewing environmental work", "Green Goods today · current product screens", { fit: "contain" }),
        image("/work/green-goods/project-context.webp", "Green Goods illustration connecting environmental work, evidence, and exchange", "Green Goods today · project context", { fit: "contain" }),
      ] },
    ],
    ...
    seoDescription: "How Green Goods was designed around field constraints, conservation evidence, operator review, and verifiable impact.",
  },
  {
    slug: "northern-trust",
    visibility: "archived",
    ...
    cardDescription: "A motion and interaction system designed directly around an existing enterprise website, codebase, and design language.",
    proof: "Initial 6-week engagement extended through 2021",
    industry: "Financial services",
    role: "UX design & front-end development",
    relationship: "Prior team work",
    timeline: "2020–2021",
    description: "Motion design and front-end development integrated into an established enterprise environment.",
    capabilities: ["UX design", "Front-end development", "Motion systems", "Implementation handoff"],
    serviceIds: [],
    accent: "slate",
    composition: "motion",
    artDirection: { world: "enterprise", hero: "wide", rhythm: "architectural", mediaFrame: "film" },
    cardMedia: image("/work/northern-trust/7IIi7cutMzY.webp", "Poster frame from a Northern Trust scroll-based motion experiment", "Published Northern Trust motion experiment · homepage scroll", { fit: "cover" }),
    heroMedia: { kind: "youtube", youtubeId: "7IIi7cutMzY", poster: "/work/northern-trust/7IIi7cutMzY.webp", title: "Northern Trust homepage scroll motion experiment", caption: "Published Northern Trust motion experiment · click to play" },
    sections: [
      { label: "Context", title: "The website was not a blank canvas.", body: "Northern Trust wanted its redesigned corporate website to feel more dynamic without turning motion into decoration or creating an implementation layer the internal team could not maintain." },
      { label: "Analysis", title: "Choose motion by impact and effort.", body: "The work began with brand immersion and an audit of the existing experience. Opportunities were plotted by likely value and implementation effort so experiments could focus on comprehension, hierarchy, and feel rather than subjective animation preferences." },
      { label: "Intervention", title: "Prototype in the medium that ships.", body: "The engagement combined UX design and front-end development using GSAP, Vue, HTML, and CSS. Motion explorations were tested inside the real technical context, then translated into components and patterns the team could use." },
      { label: "Handoff", title: "Implementation was part of the design.", body: "The work included final code, examples, and documentation. A motion system is only useful inside an enterprise when the people responsible for the site can understand, ship, and maintain it after the engagement." },
      { label: "Outcome", title: "Six weeks became a longer engagement.", body: "The initial six-week engagement was extended multiple times through 2020 and 2021. No unsupported engagement or company-performance metric is attached to this case." },
    ],
    visualBlocks: [
      { afterSection: 1, eyebrow: "Prioritization", title: "A practical way to decide where motion belonged.", layout: "single", media: [image("/work/northern-trust/impact-return-matrix.webp", "Whiteboard impact and return matrix used to prioritize Northern Trust motion opportunities", "Impact and return matrix from the original engagement", { fit: "contain" })] },
      { afterSection: 2, eyebrow: "Published experiments", title: "Motion was tested as part of the interface, not as decoration.", intro: "Videos load only after selection. Poster frames remain visible when reduced motion is preferred.", layout: "filmstrip", media: [
        { kind: "youtube", youtubeId: "DKmFuTVYvj4", poster: "/work/northern-trust/DKmFuTVYvj4.webp", title: "Northern Trust promotional card motion experiment", caption: "Promo card motion exploration" },
        { kind: "youtube", youtubeId: "NWuMI7CY1Cc", poster: "/work/northern-trust/NWuMI7CY1Cc.webp", title: "Northern Trust alternate promotional card motion experiment", caption: "Promo card motion exploration · alternate" },
        { kind: "youtube", youtubeId: "ahSfTIIveBI", poster: "/work/northern-trust/ahSfTIIveBI.webp", title: "Northern Trust header zoom motion experiment", caption: "Header zoom exploration" },
      ] },
    ],
    ...
    seoDescription: "A UX and front-end engagement that designed, built, prioritized, and documented motion within an existing enterprise website.",
  },
] as const;
...
export const archivedWorkProjects = workProjects.filter((project) => project.visibility === "archived");
