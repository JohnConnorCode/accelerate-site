...
export const OPEN_SOURCE_STATS: OpenSourceStat[] = [
  { value: "70", label: "Ordered migrations", detail: "Every schema change, in sequence" },
  { value: "202", label: "Automated checks", detail: "Test and verification scripts" },
  { value: "140K", label: "Lines of TypeScript", detail: "Across 745 source files" },
