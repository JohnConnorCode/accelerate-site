...
export const OPEN_SOURCE_STATS: OpenSourceStat[] = [
  { value: "89", label: "Ordered migrations", detail: "Every schema change, in sequence" },
  { value: "235", label: "Automated checks", detail: "Test and verification scripts" },
  { value: "167K", label: "Lines of TypeScript", detail: "Across 868 source files" },
