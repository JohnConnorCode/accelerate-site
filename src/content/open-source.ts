...
export const OPEN_SOURCE_STATS: OpenSourceStat[] = [
  { value: "76", label: "Ordered migrations", detail: "Every schema change, in sequence" },
  { value: "218", label: "Automated checks", detail: "Test and verification scripts" },
  { value: "148K", label: "Lines of TypeScript", detail: "Across 778 source files" },
