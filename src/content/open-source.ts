...
export const OPEN_SOURCE_STATS: OpenSourceStat[] = [
  { value: "78", label: "Ordered migrations", detail: "Every schema change, in sequence" },
  { value: "221", label: "Automated checks", detail: "Test and verification scripts" },
  { value: "149K", label: "Lines of TypeScript", detail: "Across 780 source files" },
