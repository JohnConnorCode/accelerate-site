...
export const OPEN_SOURCE_STATS: OpenSourceStat[] = [
  { value: "105", label: "Ordered migrations", detail: "Every schema change, in sequence" },
  { value: "252", label: "Automated checks", detail: "Test and verification scripts" },
  { value: "183K", label: "Lines of TypeScript", detail: "Across 963 source files" },
