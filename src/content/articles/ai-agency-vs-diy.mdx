...
<StatHighlight
  value="20+ hrs/week"
  label="average time business owners spend on tasks that could be automated"
/>
...
<Callout type="warning" title="Watch out for vanity metrics">
  Some agencies report on impressions, clicks, or "engagement." Ask for the numbers that matter:
  inquiries generated, appointments booked, revenue influenced. If they cannot tie their work to
  your bottom line, keep looking.
</Callout>
...
**We build and run it.** This is the key difference. We are your embedded operations team. We build the systems and we run them. We build the systems, manage the systems, and optimize the systems. You focus on running your business.
...
<QuoteBlock
  quote="The question is whether doing it yourself is the best use of your time."
  author="Accelerate"
/>
