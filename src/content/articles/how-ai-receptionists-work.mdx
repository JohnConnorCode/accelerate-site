...
**Training on thin content.** If your AI receptionist is trained on a website with three pages and no FAQ, it will flounder on the fourth question. We learned this the hard way when we set up an AI agent for [a roofing company](/industries/home-services). The original training data was missing financing information, and 15% of callers were asking about it. We added a detailed FAQ document covering 40+ common questions, and response accuracy jumped from about 80% to over 95%.
...
We helped [a roofing company grow inquiries 4x](/industries/home-services) with exactly this approach -- an AI receptionist paired with [automated follow-up](/services#engagement).
