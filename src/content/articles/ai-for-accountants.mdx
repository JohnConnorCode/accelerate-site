...
<StatHighlight value="62%" label="of an accountant's time during tax season is spent on administrative tasks, not actual accounting work" />
...
<StatHighlight value="90%" label="reduction in administrative time per client when onboarding is fully automated" />
