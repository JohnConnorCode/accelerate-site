...
<StatHighlight value="Second touch" label="on every estimate, without waiting for someone to have an evening" />
...
<StatHighlight value="Past clients" label="reached when the season actually calls for the work you already did for them" />

<Callout type="important" title="The Lifetime Value Play">
Seasonal re-engagement is about staying top-of-mind. The client who books a $150 tune-up this spring is the client who calls you for a $12,000 system replacement next year instead of searching Google and finding your competitor. Re-engagement protects lifetime value.
</Callout>
