...
**SMS-only sequences.** Some businesses skip email entirely and send all follow-ups via text. This works for the first message but burns out fast. By message three, response rates crater. We found the best approach is SMS for urgent, time-sensitive touchpoints (confirmation, day-1 check-in) and email for value content (case studies, educational resources). [Montoya Capital](/industries/professional-services) uses exactly this mix: their AI response system engages prospects in under 3 minutes via text, then shifts to email for the nurture sequence. Consultation rate up 40%.
...
**No channel for the warm prospect who is not ready.** If your only follow-up options are "book now" and silence, you lose everyone in between. Build a monthly newsletter or resource drip for prospects who are interested but not ready yet. We do this for every client, including [Farrell Roofing](/industries/home-services), where long-term nurture emails convert prospects months after the initial inquiry.
