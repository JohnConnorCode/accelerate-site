...
export const changelogEntries: ChangelogEntry[] = [
  { id: "continuous-navigation-runtime", slug: "continuous-navigation-runtime", title: "Navigation now behaves like one continuous application", description: "Public pages, the founder workspace, and all three fictional demos now share one navigation runtime. New destinations begin at the top, browser history restores the exact prior reading position, admin navigation stays inside its application viewport, and demo links remain in the selected fictional business without document-level interception or hard reloads. Incoming pages use one restrained blur-and-rise entrance, reduced motion remains immediate, slow transitions receive stable loading feedback, and each admin destination receives a contextual browser title and focus handoff.", category: "improvement", publishedAt: "2026-08-27" },
