...
description: "The recovery step for the setup, access, and action failures you'll actually hit, by symptom."
updated: "2026-09-09"
---

Most failures here have a specific, boring fix once you know which symptom you are looking at. Start with what you can actually observe: the time, the workspace, the page, and the exact error text, recorded before you change any configuration, since a change you can't undo is a lot harder to diagnose after the fact than before it. Leave credentials and customer message content out of anything you share.
