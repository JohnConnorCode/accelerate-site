...
description: "The recovery step for the setup, access, and action failures you'll hit, by symptom."
updated: "2026-09-19"
---

When a workflow stops, begin with the step that failed and the result you can observe. Record the workspace, page, time and visible error, then follow the matching recovery path below. That context helps you repair the cause while preserving any work already saved.
