...
On the sign-in screen, choose **Forgot password?**, enter the configured admin email, and choose **Send reset link**. Open the recovery message to continue. If the link has expired, request a new one from the same screen. **Back to sign in** returns you to the email and password fields.
