...
Open `/admin/learning` to review what the business wants to remember. A learning is a reusable correction with a type, scope, confidence, and source — for example, that proposals should never lead with AI capabilities, or that customers are called members, never users.
