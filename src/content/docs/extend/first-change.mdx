...
Replace `<reviewed-branch>` with the supplied branch. Compare the printed commit with the commit supplied by the maintainer. Resolve a mismatch before continuing.
