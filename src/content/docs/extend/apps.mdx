...
An App can be a complete business capability: records, workflows, integrations, an interface, and tools an assistant can use. A small report is one useful shape for that. A dispatch console, a creative-review system, or an equipment-maintenance workspace is a much larger one, and the same underlying pattern supports both.
