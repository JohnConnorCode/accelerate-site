...
Opportunity Radar is the largest example in this library, and it shows how a plugin can carry the context of one particular business without ever baking that business into the platform itself. A profile describes the organization, its expertise, and its audiences, and the workspace keeps supplied sources, reviewed opportunities, relationship context, and drafts together so an operator can actually decide what's worth pursuing.
