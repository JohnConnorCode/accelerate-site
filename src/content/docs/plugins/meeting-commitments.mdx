...
A meeting produces useful follow-up when each agreed commitment has an owner and date. Meeting commitments takes the checklist you enter and connects its tasks to the stored meeting, so the team can trace the work back to its source.
