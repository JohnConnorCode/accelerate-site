...
When building your first extension, start with a small example whose registration you can inspect end to end. The Inventory example provides a page, navigation entry and settings, so you can learn how a module becomes available in a workspace.
