...
export const caseStudies: CaseStudyFull[] = [
  ...
  },
  {
    ...
    solution:
      "Deployed a full AI intake system that qualifies potential clients instantly, asks the right screening questions, and books consultations directly on the attorneys' calendars. Built a new conversion-optimized website with dedicated landing pages for each practice area. Set up automated drip campaigns for prospects that aren't ready to commit immediately.",
    results:
      "Consultation bookings increased by 185% within the first 60 days. Their cost per acquisition dropped from $340 to $125 because the AI agent pre-qualifies inquiries before they ever speak with an attorney. The firm signed 12 additional cases in the first quarter worth an estimated $180,000 in fees.",
    testimonialQuote:
      "The AI intake system is like having a paralegal that works 24/7. Our consultation-to-client conversion rate doubled because every prospect that reaches an attorney is already qualified.",
  ...
  },
  {
    ...
    challenge:
      "Compass Financial was relying entirely on referrals and had zero digital client acquisition. Their website was a basic template with no SEO, no inquiry capture, and no way for prospects to schedule consultations online. The two partners were spending 10+ hours per week on administrative tasks that could be automated.",
    solution:
    ...
    results:
      "Compass went from zero online inquiries to 28 qualified prospects per month within 90 days. The automated onboarding process saved each partner 6 hours per week. They brought on 8 new clients in the first quarter, representing approximately $2.4M in assets under management.",
    testimonialQuote:
      "We went from being invisible online to getting more qualified prospects than we can handle. The automation saved us enough time to actually service all the new clients properly.",
