...
export const caseStudies: CaseStudyFull[] = [
    ...
    metrics: [
      {
        ...
        before: "Inconsistent, mostly word-of-mouth",
        after: "Dramatic increase across all channels",
        improvement: "Significant growth",
      },
      {
        label: "Response Time",
      ...
      },
      {
        ...
        before: "Steady but plateaued",
        after: "Meaningful jump in booked jobs",
        improvement: "Strong uplift",
      },
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      {
        label: "Client Growth",
        before: "Capped by manual bandwidth",
        after: "Scaled significantly in Q1",
        improvement: "Major expansion",
      },
      {
        label: "Admin Hours",
        before: "20+ hours/week on repetitive tasks",
        after: "Founders back on product & strategy",
        improvement: "Hours reclaimed",
      },
      {
        label: "Response Time",
        before: "Hours to reply",
        after: "Under 3 minutes, automated",
        improvement: "Near-instant",
      },
    ],
    ...
    metrics: [
      {
        ...
        before: "Low conversion from inquiries",
        after: "Significant jump in bookings",
        improvement: "Strong increase",
      },
      {
        label: "Response Time",
        before: "Next business day at best",
        after: "Under 3 minutes, any time",
        improvement: "Near-instant",
      },
      {
        label: "After-Hours Capture",
      ...
      {
        label: "New Clients",
        before: "Referrals only, unpredictable",
        after: "Consistent digital pipeline",
        improvement: "Steady growth",
      },
    ],
    services: ["AI-Powered Website", "AI Chat Agent", "Automated Follow-Up"],
    timeline: "4 weeks",
