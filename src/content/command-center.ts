...
export const capabilities: Capability[] = [
...

  {
    ...
    detail:
      "Prepare source-backed drafts, approve exact content and schedules, and follow Postiz acceptance through to verified LinkedIn publication. Each workspace connects its own organization, with a bundled app deployment, private draft media and operator-controlled service setup; uncertain submissions retain their receipts for review.",
    gated: true,
  },
