...
export const capabilities: Capability[] = [
  // ── Capture: what comes in gets recorded ──────────────────────────────
  {
    ...
    detail:
      "Connected Drive indexing makes available text searchable. Review extracted information against the source; processing depends on the configured sync, supported file type and available AI workflow.",
  },
  {
    id: "paste",
    category: "capture",
