...
BEGIN
 ...
 IF NOT FOUND OR to_jsonb(conversation) IS DISTINCT FROM p_payload->'conversationState' THEN RAISE EXCEPTION 'Conversation changed since identity review; prepare a new decision'; END IF;
