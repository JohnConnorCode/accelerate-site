...
INSERT INTO storage.buckets(id,name,public,file_size_limit,allowed_mime_types)
 VALUES('workspace-knowledge','workspace-knowledge',false,8388608,ARRAY['application/pdf','application/vnd.openxmlformats-officedocument.wordprocessingml.document','text/plain','text/markdown'])
...
BEGIN
 IF length(btrim(p_query)) NOT BETWEEN 2 AND 200 OR p_limit NOT BETWEEN 1 AND 25 THEN RAISE EXCEPTION 'Use a 2–200 character query and a limit of 1–25'; END IF;
