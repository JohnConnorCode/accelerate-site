...
BEGIN
 ...
 VALUES(t,p_actor_email,'site_website.'||p_operation,'site_website',t::text,
  CASE WHEN current_setting('app.site_editor_delegation',true)='true' THEN 'ai' ELSE 'admin' END,result);
 RETURN result;
END $$;
