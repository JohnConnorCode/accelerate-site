...
- Routine Kanban reads, card edits and reconciliation use the repository CLI and
  canonical work-board service contract. Do not research Supabase documentation
  for those operations. Provider documentation is relevant when changing the
  database integration, schema, authorization or provider behavior itself.
