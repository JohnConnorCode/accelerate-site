...
| `/admin/activity`            | Inspect and filter operator audit events                              | Canonical activities ledger plus retained audit events; audit fields remain source-owned.                                             |
...
| `/admin/revenue`             | Inspect recurring value and accepted proposal totals                  | Canonical opportunity totals plus retained client/proposal contract values; not cash receipts.                                        |
