...
| B — B (Agent Runtime foundation — Notice + Act primitives) | 21 | 20 | 3 | 5 | 28 | 77 |
| C — C (Reference coworker — Sales end-to-end loop) | 20 | 4 | 1 | 1 | 10 | 36 |
| D — D (Plugin SDK + MCP) | 5 | 3 | 0 | 1 | 13 | 22 |
| E — E (Additional coworkers/plugins + documentation) | 46 | 3 | 0 | 0 | 6 | 55 |

**Board total:** 92 backlog, 30 planned, 4 in progress, 8 blocked, 75 shipped (209 managed cards).
...
- `system-health-report` — Build the system-health report and freshness thresholds (claude-code:johnconnor:26718)
- `identity-review-workbench` — Build the identity review workbench (claude-code:johnconnor:30493)
